...
#links a{
	...
	font: Geneva;
	-moz-transition: color  .5s, text-shadow 1s,;
}
#links a:hover{
	color:#000;
	padding:5px;
...
<div align="center">
  <table width="1341" align="center">
    <tr>
      <td width="1220"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=5,0,0,0" width="1600" height="126" align="absmiddle">
  ...
  <table width="1600" height="512" align="center">
    <tr align="center">
      <td width="583" height="506"><h1 class="style2" >MY STUFF</h1>
          <div id="resCount">
            <h3><a href="#">TEXT</a></h3>
          <div id="txt">
