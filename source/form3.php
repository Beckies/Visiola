...
<div id="dialog" title="Basic dialog">
	<form id="signupform" autocomplete="off" method="get" action="">
	  		  <table>
	  		  <tr>
	  		  	<td width="81" class="label"><label id="lfirstname" for="firstname">First Name</label></td>
	  		  	<td width="150" class="field"><input id="firstname" name="firstname" type="text" value="" maxlength="100" /></td>
	  		  	<td width="390" class="status"></td>
	  		  </tr>
	  		  <tr>
